...
import org.valkyrienskies.vs_template.platform.PlatformHelper
...
object VSTemplateMod {
    ...
    fun init() {
        LOG.info(
            ...
            PlatformHelper.INSTANCE.platformName,
            PlatformHelper.INSTANCE.getEnvironmentName()
        )
        ...
        if (PlatformHelper.INSTANCE.isModLoaded("examplemod")) {
